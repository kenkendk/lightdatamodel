...
namespace System.Data.LightDatamodel
{
	...
	public class DataFetcherCached : DataFetcher, IDataFetcherCached
	{
        ...
        protected RelationManager m_relationManager = new RelationManager();
		...
		protected override void HookObject(IDataClass obj)
		{
			...
			if (!m_relationManager.IsPrimaryKeyAutoGenerated(obj) || m_relationManager.ExistsInDb(obj))
			{
		...
		public virtual DATACLASS[] GetObjects<DATACLASS>(QueryModel.Operation operation) where DATACLASS : IDataClass
		{
			...
			InsertObjectsInCache(LoadObjects(type, op));
		...
		public override void Commit(IDataClass obj)
		{
			...
			{
				if (m_relationManager.ExistsInDb(obj) || !m_relationManager.IsPrimaryKeyAutoGenerated(obj))
					base.Commit(obj);
			}
