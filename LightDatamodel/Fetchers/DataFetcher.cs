            ...
            try
            {
				...
				if (typeinfo.PrimaryKey.IsAutoGenerated)
				{
					lock (m_insertlock)		//sad really. But GetLastAutogeneratedValue must be syncronised
					{
						...
						object oldvalue = typeinfo.PrimaryKey.Field.GetValue(obj);
						DataClassBase dbb = obj as DataClassBase;
						dbb.OnBeforeDataChange(obj, typeinfo.PrimaryKey.Databasefield, oldvalue, newprimarykey);
						typeinfo.PrimaryKey.Field.SetValue(obj, newprimarykey);
						dbb.OnAfterDataChange(obj, typeinfo.PrimaryKey.Databasefield, oldvalue, newprimarykey);
					}
				}
				else
				{
