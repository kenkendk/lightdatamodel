namespace LimeTime
{
    partial class SearchForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.textBoxWithFancyAutoComplete1 = new System.Windows.Forms.TextBoxWithFancyAutoComplete();
			...
			// 
			// textBoxWithFancyAutoComplete1
			// 
			this.textBoxWithFancyAutoComplete1.Location = new System.Drawing.Point(40, 8);
			this.textBoxWithFancyAutoComplete1.Name = "textBoxWithFancyAutoComplete1";
			this.textBoxWithFancyAutoComplete1.Size = new System.Drawing.Size(328, 20);
			this.textBoxWithFancyAutoComplete1.TabIndex = 0;
			this.textBoxWithFancyAutoComplete1.TextChanged += new System.EventHandler(this.textBoxWithFancyAutoComplete1_TextChanged);
			// 
			// SearchForm
			// 
			...
			this.Controls.Add(this.textBoxWithFancyAutoComplete1);
		...
		private System.Windows.Forms.TextBoxWithFancyAutoComplete textBoxWithFancyAutoComplete1;
    }
}
