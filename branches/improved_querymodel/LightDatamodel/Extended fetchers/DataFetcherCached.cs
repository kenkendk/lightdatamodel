...
namespace System.Data.LightDatamodel
{
	...
	public class DataFetcherCached : DataFetcher, IDataFetcherCached
	{
		...
		public override DATACLASS[] GetObjects<DATACLASS>(QueryModel.Operation operation)
		{
            ...
            QueryModel.Operation filter = Query.Equal(Query.Property("GetType.FullName"), Query.Value(typeof(DATACLASS).FullName));
		...
		public override object[] GetObjects(Type type, QueryModel.Operation operation)
		{
            ...
            QueryModel.Operation filter = Query.Equal(Query.Property("GetType.FullName"), Query.Value(type.FullName));
                ...
                if (item as DataClassBase != null)
                {
                    ...
                    if (!m_cache[tablename].ContainsKey(dbitem.UniqueValue))
                    {
                        ...
                        QueryModel.Operation opdeleted =
                            Query.And(
                                Query.Equal(Query.Property("GetType.FullName"), Query.Value(item.GetType().FullName)),
