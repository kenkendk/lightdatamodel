	...
	public class DataFetcherCached : DataFetcher, IDataFetcherCached
	{
		...
		public override object GetObjectById(Type type, object id)
		{
			...
			else
			{
				...
				QueryModel.Operation filter = new System.Data.LightDatamodel.QueryModel.Operation(System.Data.LightDatamodel.QueryModel.Operators.And, QueryModel.Parser.ParseQuery(m_transformer.TypeConfiguration.GetTypeInfo(type).PrimaryKey.ColumnName + "=?", id), QueryModel.Parser.ParseQuery("GetType.FullName = ?", type.FullName));
